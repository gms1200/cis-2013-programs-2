...
{
    var s = (floatTriSide1_par + floatTriSide2_par + floatTriSide3_par) / 2;
	var floatArea = parseFloat (Math.sqrt(s * (s - floatTriSide1_par) * (s - floatTriSide2_par) * (s - floatTriSide3_par)));
	return floatArea.toFixed(2);
}
...
{
	var floatArea = parseFloat (pi * floatRadius_par * floatRadius_par);
	return floatArea.toFixed(2);
}
...
var calcCircleArea = function()
{
	...
	alert ("The Circle area is " + circleCircum(floatRadius));	
};
